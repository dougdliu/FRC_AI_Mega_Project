...
| `sim_engineer` | 2D/Physics Simulator | TideSim-style multiplayer game loop, collision detection, kinematics, architecture parameter sliders | `pygame`/`p5.js`, `box2d` | Input: Robot params → Output: Interactive 2D sim + parameter JSON + `sim_arch_feedback.json` |
